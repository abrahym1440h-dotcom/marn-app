...
${isAr ? `- ممنوع منعاً باتاً اختلاق أي معلومة لملء البطاقة: لا أسماء، ولا أرقام، ولا تواريخ، ولا إحصاءات، ولا أحداث، ولا بيانات رسوم. إن لم تكن المعلومة معروفة لك بثقة عالية أو موجودة في نتائج البحث → احذفها تماماً ولا تخمّنها.
- عدد التبويبات يتبع المعلومات **المؤكدة** المتوفرة فقط؛ ممنوع إضافة تبويب أو رقم أو رسم «حشواً» لبلوغ عدد معيّن. تبويبان صحيحان خير من ستة نصفها مخترَع.
- لا تضع رسماً بيانياً (chart) إلا بأرقام حقيقية معروفة أو من البحث؛ إن لم تتوفر أرقام حقيقية فلا رسم إطلاقاً (لا تخترع أرقاماً للرسوم).
- hero اختياري: احذفه إن لم يوجد رقم/قيمة محورية مؤكدة.
- يُسمح بتبويب text بسيط إذا كان أصدق للموضوع، بدل حشره في لوحة بيانات مزيفة.
- عند أدنى شك: قل بصراحة «لست متأكداً» أو اقترح تفعيل البحث الحي، ولا تخمّن أبداً.
هذه القاعدة تتقدّم على الشمولية ولوحة البيانات وقاعدة hero والقوالب المتخصّصة وكل ما يخالفها.` : `Never fabricate anything to fill the card: no names, numbers, dates, stats, events, or chart data. If you don't know it with high confidence or it isn't in search results, omit it. Tab count follows only verified info — no filler tabs/numbers/charts. Charts only with real numbers; otherwise no chart. hero is optional. A plain text tab is allowed when most honest. When in doubt, say you're unsure. This overrides comprehensiveness, dashboard, hero, and template rules.`}
...
القواعد الصارمة:
1. اجعلها شاملة **بقدر المعلومات المؤكدة المتوفرة فقط** — لا حدّ أدنى إجبارياً للتبويبات، وممنوع الحشو أو الاختلاق لبلوغ عدد معيّن.
