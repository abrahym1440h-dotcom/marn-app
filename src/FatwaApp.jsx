...
import {
  Home, MessageCircle, BookOpen, Heart, Clock, Activity, Calendar,
  BarChart3, HelpCircle, ShieldCheck, Menu, X, ChevronDown, ChevronLeft,
  Search, Send, ArrowRight, MapPin, Sunrise, Sun, Sunset, Moon, CloudSun,
  Plus, Minus, Check, RefreshCw, Sparkles, ExternalLink, Compass, Star,
  Loader2, Coins, Users, Globe, Flower2, Scale, ScrollText, Droplet, Bell,
} from 'lucide-react';
